...
export const tool$spansSubmitSpanFeedbackSpansSpanIdFeedbackPost:
  ToolDefinition<typeof args> = {
    name: "spans-submit-span-feedback-spans-span-id-feedback-post",
...
- Intermediate values (e.g., 0.5) are supported for nuanced feedback`,
    ...
    tool: async (client, args, ctx) => {
      const [result, apiCall] =
        await spansSubmitSpanFeedbackSpansSpanIdFeedbackPost(
          client,
          args.spanId,
