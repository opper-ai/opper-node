...
export namespace CreateFunctionRequest$ {
  /** @deprecated use `CreateFunctionRequest$inboundSchema` instead. */
  export const inboundSchema = CreateFunctionRequest$inboundSchema;
  /** @deprecated use `CreateFunctionRequest$outboundSchema` instead. */
  export const outboundSchema = CreateFunctionRequest$outboundSchema;
  /** @deprecated use `CreateFunctionRequest$Outbound` instead. */
  export type Outbound = CreateFunctionRequest$Outbound;
}
