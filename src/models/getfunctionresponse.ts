...
export namespace GetFunctionResponse$ {
  /** @deprecated use `GetFunctionResponse$inboundSchema` instead. */
  export const inboundSchema = GetFunctionResponse$inboundSchema;
  /** @deprecated use `GetFunctionResponse$outboundSchema` instead. */
  export const outboundSchema = GetFunctionResponse$outboundSchema;
  /** @deprecated use `GetFunctionResponse$Outbound` instead. */
  export type Outbound = GetFunctionResponse$Outbound;
}
