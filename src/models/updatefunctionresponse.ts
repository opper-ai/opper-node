...
export namespace UpdateFunctionResponse$ {
  /** @deprecated use `UpdateFunctionResponse$inboundSchema` instead. */
  export const inboundSchema = UpdateFunctionResponse$inboundSchema;
  /** @deprecated use `UpdateFunctionResponse$outboundSchema` instead. */
  export const outboundSchema = UpdateFunctionResponse$outboundSchema;
  /** @deprecated use `UpdateFunctionResponse$Outbound` instead. */
  export type Outbound = UpdateFunctionResponse$Outbound;
}
