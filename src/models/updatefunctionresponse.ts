...
/** @internal */
export const UpdateFunctionResponse$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  observer_enabled: z.boolean().default(false),
...
/** @internal */
export type UpdateFunctionResponse$Outbound = {
  name: string;
  description?: string | null | undefined;
  instructions: string;
...
/** @internal */
export const UpdateFunctionResponse$outboundSchema: z.ZodType<
  UpdateFunctionResponse$Outbound,
  z.ZodTypeDef,
  UpdateFunctionResponse
> = z.object({
  name: z.string(),
  ...
  observerEnabled: z.boolean().default(false),
...
export function updateFunctionResponseToJSON(
  updateFunctionResponse: UpdateFunctionResponse,
): string {
  return JSON.stringify(
    UpdateFunctionResponse$outboundSchema.parse(updateFunctionResponse),
  );
}
export function updateFunctionResponseFromJSON(
  jsonString: string,
): SafeParseResult<UpdateFunctionResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UpdateFunctionResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UpdateFunctionResponse' from JSON`,
  );
}
