 ...
 */
export function datasetsQueryEntries(
  client: OpperCore,
  datasetId: string,
  query: string,
  ...
  Result<
    Array<models.QueryDatasetEntriesResponse>,
...
> {
  const input:
    operations.QueryDatasetEntriesDatasetsDatasetIdEntriesQueryPostRequest = {
      datasetId: datasetId,
      query: query,
      limit: limit,
    };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.QueryDatasetEntriesResponse$inboundSchema)),
