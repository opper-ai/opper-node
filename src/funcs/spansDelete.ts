...
> {
  const input: operations.DeleteSpanSpansSpanIdDeleteRequest = {
    spanId: spanId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeleteSpanSpansSpanIdDeleteRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "delete_span_spans__span_id__delete",
    oAuth2Scopes: null,
