 ...
 */
export function languageModelsDeleteCustom(
  client: OpperCore,
  modelId: string,
...
> {
  const input: operations.DeleteCustomModelModelsCustomModelIdDeleteRequest = {
    modelId: modelId,
  };
  ...
  const context = {
    ...
    operationID: "delete_custom_model_models_custom__model_id__delete",
    oAuth2Scopes: null,
