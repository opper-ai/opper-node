...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CallFunctionFunctionsFunctionIdCallPostRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/functions/{function_id}/call")(pathParams);
  ...
  const context = {
    ...
    operationID: "call_function_functions__function_id__call_post",
    oAuth2Scopes: null,
