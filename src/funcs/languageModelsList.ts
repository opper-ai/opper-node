 ...
 */
export function languageModelsList(
  client: OpperCore,
...
> {
  const input: operations.ListModelsModelsGetRequest = {
    offset: offset,
    limit: limit,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListModelsModelsGetRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      models.PaginatedResponseListLanguageModelsResponse$inboundSchema,
    ),
