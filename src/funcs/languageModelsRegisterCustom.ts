...
> {
  const parsed = safeParse(
    request,
    (value) => models.RegisterCustomModelRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "register_custom_model_models_custom_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RegisterCustomModelResponse$inboundSchema),
