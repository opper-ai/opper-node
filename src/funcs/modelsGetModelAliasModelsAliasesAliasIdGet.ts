 ...
 */
export function modelsGetModelAliasModelsAliasesAliasIdGet(
  client: OpperCore,
  aliasId: string,
...
> {
  const input: operations.GetModelAliasModelsAliasesAliasIdGetRequest = {
    aliasId: aliasId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetModelAliasModelsAliasesAliasIdGetRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "get_model_alias_models_aliases__alias_id__get",
    oAuth2Scopes: null,
