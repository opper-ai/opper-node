 ...
 */
export function knowledgeDeleteFile(
  client: OpperCore,
...
> {
  const input:
    operations.DeleteFileFromKnowledgeBaseKnowledgeKnowledgeBaseIdFilesFileIdDeleteRequest =
      {
  ...
  const path = pathToFunc("/knowledge/{knowledge_base_id}/files/{file_id}")(
    pathParams,
  );
