 ...
 */
export function languageModelsGetCustomByName(
  client: OpperCore,
  name: string,
...
> {
  const input: operations.GetCustomModelByNameModelsCustomByNameNameGetRequest =
    {
      name: name,
    };
  ...
  const path = pathToFunc("/models/custom/by-name/{name}")(pathParams);
  ...
  const context = {
    ...
    operationID: "get_custom_model_by_name_models_custom_by_name__name__get",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetCustomModelResponse$inboundSchema),
