...
> {
  const input: operations.ListFilesKnowledgeKnowledgeBaseIdFilesGetRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListFilesKnowledgeKnowledgeBaseIdFilesGetRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/knowledge/{knowledge_base_id}/files")(pathParams);
  ...
  const context = {
    ...
    operationID: "list_files_knowledge__knowledge_base_id__files_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PaginatedResponseListFilesResponse$inboundSchema),
