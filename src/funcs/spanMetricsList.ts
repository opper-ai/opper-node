 ...
 */
export function spanMetricsList(
  client: OpperCore,
  spanId: string,
...
> {
  const input: operations.ListMetricsSpansSpanIdMetricsGetRequest = {
    spanId: spanId,
    offset: offset,
    limit: limit,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListMetricsSpansSpanIdMetricsGetRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_metrics_spans__span_id__metrics_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PaginatedResponseListSpanMetricsResponse$inboundSchema),
