 ...
 */
export function knowledgeGetByName(
  client: OpperCore,
...
> {
  const input:
    operations.GetKnowledgeBaseByNameKnowledgeByNameKnowledgeBaseNameGetRequest =
      {
  ...
  const pathParams = {
    knowledge_base_name: encodeSimple(
      "knowledge_base_name",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetKnowledgeBaseResponse$inboundSchema),
