...
> {
  const input:
    operations.PutSteeringFunctionsFunctionIdConfigSteeringPutRequest = {
  ...
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .PutSteeringFunctionsFunctionIdConfigSteeringPutRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.SteeringConfig, { explode: true });
  ...
  const path = pathToFunc("/functions/{function_id}/config/steering")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "put_steering_functions__function_id__config_steering_put",
    oAuth2Scopes: null,
