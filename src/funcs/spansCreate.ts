...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateSpanRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_span_spans_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateSpanResponse$inboundSchema),
