 ...
 */
export function spansSaveExamples(
  client: OpperCore,
  spanId: string,
...
> {
  const input: operations.SaveToDatasetSpansSpanIdSaveExamplesPostRequest = {
    spanId: spanId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SaveToDatasetSpansSpanIdSaveExamplesPostRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "save_to_dataset_spans__span_id__save_examples_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.SaveToDatasetResponse$inboundSchema),
