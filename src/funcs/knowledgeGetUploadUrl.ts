 ...
 */
export function knowledgeGetUploadUrl(
  client: OpperCore,
...
> {
  const input:
    operations.GetUploadUrlKnowledgeKnowledgeBaseIdUploadUrlGetRequest = {
  ...
  const path = pathToFunc("/knowledge/{knowledge_base_id}/upload_url")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "get_upload_url_knowledge__knowledge_base_id__upload_url_get",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetUploadUrlResponse$inboundSchema),
