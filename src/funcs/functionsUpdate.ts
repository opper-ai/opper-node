 ...
 */
export function functionsUpdate(
  client: OpperCore,
  functionId: string,
...
> {
  const input: operations.UpdateFunctionFunctionsFunctionIdPatchRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UpdateFunctionFunctionsFunctionIdPatchRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateFunctionRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "update_function_functions__function_id__patch",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateFunctionResponse$inboundSchema),
