 ...
 * relevance score.
 */
export function rerankRerankDocumentsRerankPost(
  client: OpperCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.RerankRequestModel$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "rerank_documents_rerank_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RerankResponseModel$inboundSchema),
