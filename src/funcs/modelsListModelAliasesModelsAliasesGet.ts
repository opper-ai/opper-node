 ...
 */
export function modelsListModelAliasesModelsAliasesGet(
  client: OpperCore,
...
> {
  const input: operations.ListModelAliasesModelsAliasesGetRequest = {
    offset: offset,
    limit: limit,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListModelAliasesModelsAliasesGetRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_model_aliases_models_aliases_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      models.PaginatedResponseListModelAliasesResponseItem$inboundSchema,
    ),
