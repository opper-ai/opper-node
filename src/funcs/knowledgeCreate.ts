...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateKnowledgeBaseRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_knowledge_base_knowledge_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateKnowledgeBaseResponse$inboundSchema),
