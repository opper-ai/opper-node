...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateEmbeddingRequest$outboundSchema.parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "404", "422", "4XX", "502", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateEmbeddingResponse$inboundSchema),
    M.jsonErr(400, errors.BadRequestError$inboundSchema),
    M.jsonErr(401, errors.UnauthorizedError$inboundSchema),
    M.jsonErr(404, errors.NotFoundError$inboundSchema),
    M.jsonErr(422, errors.ErrorT$inboundSchema),
    M.jsonErr(502, errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
