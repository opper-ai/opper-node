 ...
 * Usage
 */
export function analyticsGetUsage(
  client: OpperCore,
  ...
  Result<
    Array<models.GetUsageResultItemOutput>,
...
> {
  const input: operations.UsageAnalyticsUsageGetRequest = {
    fromDate: fromDate,
    toDate: toDate,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UsageAnalyticsUsageGetRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/analytics/usage")();
  ...
  const context = {
    ...
    operationID: "usage_analytics_usage_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.GetUsageResultItemOutput$inboundSchema)),
