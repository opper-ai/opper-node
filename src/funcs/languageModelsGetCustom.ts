 ...
 */
export function languageModelsGetCustom(
  client: OpperCore,
  modelId: string,
...
> {
  const input: operations.GetCustomModelModelsCustomModelIdGetRequest = {
    modelId: modelId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetCustomModelModelsCustomModelIdGetRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "get_custom_model_models_custom__model_id__get",
    oAuth2Scopes: [],
