 ...
 */
export function datasetsListEntries(
  client: OpperCore,
  datasetId: string,
...
> {
  const input: operations.ListDatasetEntriesDatasetsDatasetIdEntriesGetRequest =
    {
      datasetId: datasetId,
      offset: offset,
      limit: limit,
  ...
  const path = pathToFunc("/datasets/{dataset_id}/entries")(pathParams);
  ...
  const context = {
    ...
    operationID: "list_dataset_entries_datasets__dataset_id__entries_get",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      models.PaginatedResponseGetDatasetEntriesResponse$inboundSchema,
    ),
