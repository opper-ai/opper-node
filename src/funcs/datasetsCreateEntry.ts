 ...
 */
export function datasetsCreateEntry(
  client: OpperCore,
  datasetId: string,
...
> {
  const input: operations.CreateDatasetEntryDatasetsDatasetIdPostRequest = {
    datasetId: datasetId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CreateDatasetEntryDatasetsDatasetIdPostRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.CreateDatasetEntryRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "create_dataset_entry_datasets__dataset_id__post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateDatasetEntryResponse$inboundSchema),
