 ...
 */
export function functionsGetByName(
  client: OpperCore,
  name: string,
...
> {
  const input: operations.GetFunctionByNameFunctionsByNameNameGetRequest = {
    name: name,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetFunctionByNameFunctionsByNameNameGetRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/functions/by-name/{name}")(pathParams);
  ...
  const context = {
    ...
    operationID: "get_function_by_name_functions_by_name__name__get",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetFunctionResponse$inboundSchema),
