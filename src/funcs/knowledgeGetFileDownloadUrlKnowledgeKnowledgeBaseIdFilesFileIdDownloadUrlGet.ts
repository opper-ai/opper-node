 ...
 */
export function knowledgeGetFileDownloadUrlKnowledgeKnowledgeBaseIdFilesFileIdDownloadUrlGet(
  client: OpperCore,
...
> {
  const input:
    operations.GetFileDownloadUrlKnowledgeKnowledgeBaseIdFilesFileIdDownloadUrlGetRequest =
      {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FileDownloadUrlResponse$inboundSchema),
