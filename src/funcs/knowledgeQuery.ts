...
export function knowledgeQuery(
  ...
  Result<
    Array<models.QueryKnowledgeBaseResponse>,
...
> {
  const input:
    operations.QueryKnowledgeBaseKnowledgeKnowledgeBaseIdQueryPostRequest = {
  ...
  const body = encodeJSON("body", payload.QueryKnowledgeBaseRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.QueryKnowledgeBaseResponse$inboundSchema)),
