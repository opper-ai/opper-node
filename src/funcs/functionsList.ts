...
> {
  const input: operations.ListFunctionsFunctionsGetRequest = {
    name: name,
    sort: sort,
    offset: offset,
    limit: limit,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListFunctionsFunctionsGetRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/functions")();
  ...
  >(
    M.json(
      200,
      models.PaginatedResponseListFunctionsResponseItem$inboundSchema,
    ),
