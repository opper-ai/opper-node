 ...
 */
export function modelsDeleteModelAliasModelsAliasesAliasIdDelete(
  client: OpperCore,
  aliasId: string,
...
> {
  const input: operations.DeleteModelAliasModelsAliasesAliasIdDeleteRequest = {
    aliasId: aliasId,
  };
  ...
  const context = {
    ...
    operationID: "delete_model_alias_models_aliases__alias_id__delete",
    oAuth2Scopes: null,
