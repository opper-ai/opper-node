...
> {
  const input: operations.UpdateCustomModelModelsCustomModelIdPatchRequest = {
    modelId: modelId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UpdateCustomModelModelsCustomModelIdPatchRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateCustomModelRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "update_custom_model_models_custom__model_id__patch",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateCustomModelResponse$inboundSchema),
