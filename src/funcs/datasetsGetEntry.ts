 ...
 * Get Dataset Entry
 */
export function datasetsGetEntry(
  client: OpperCore,
  datasetId: string,
  entryId: string,
...
> {
  const input:
    operations.GetDatasetEntryDatasetsDatasetIdEntriesEntryIdGetRequest = {
      datasetId: datasetId,
      entryId: entryId,
    };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetDatasetEntryResponse$inboundSchema),
