...
let value: UpdateSpanRequest = {
  name: "my span",
  startTime: new Date("2025-11-15T17:45:59.711428Z"),
  type: "email_tool",
  endTime: new Date("2025-11-15T17:45:59.711525Z"),
  input: "Hello, world!",
  output: "Hello, world!",
...
| `startTime`                                                                                               | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)             | :heavy_minus_sign:                                                                                        | The start time of the span in UTC                                                                         | 2025-11-15T17:45:59.711428Z                                                                               |
| `type`                                                                                                    | *string*                                                                                                  | :heavy_minus_sign:                                                                                        | The type of the span                                                                                      | email_tool                                                                                                |
| `endTime`                                                                                                 | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)             | :heavy_minus_sign:                                                                                        | The end time of the span in UTC                                                                           | 2025-11-15T17:45:59.711525Z                                                                               |
