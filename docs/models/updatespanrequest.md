...
let value: UpdateSpanRequest = {
  name: "my span",
  startTime: new Date("2026-05-04T10:55:20.961319Z"),
  type: "email_tool",
  endTime: new Date("2026-05-04T10:55:20.961382Z"),
  input: "Hello, world!",
  output: "Hello, world!",
...
| `startTime`                                                                                               | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)             | :heavy_minus_sign:                                                                                        | The start time of the span in UTC                                                                         | 2026-05-04T10:55:20.961319Z                                                                               |
| `type`                                                                                                    | *string*                                                                                                  | :heavy_minus_sign:                                                                                        | The type of the span                                                                                      | email_tool                                                                                                |
| `endTime`                                                                                                 | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)             | :heavy_minus_sign:                                                                                        | The end time of the span in UTC                                                                           | 2026-05-04T10:55:20.961382Z                                                                               |
