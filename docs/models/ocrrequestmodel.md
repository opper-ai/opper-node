...
| `doclingExtra`                                                                           | [models.DoclingOCRExtra](../models/doclingocrextra.md)                                   | :heavy_minus_sign:                                                                       | Docling-specific OCR parameters (output_format, ocr_engine, force_ocr, table_mode, lang) |                                                                                          |