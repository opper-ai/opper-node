...
| `elements`                                                                                                    | [models.OCRPageElement](../models/ocrpageelement.md)[]                                                        | :heavy_minus_sign:                                                                                            | Document elements with bounding boxes and labels (only returned when using Docling with output_format='json') |