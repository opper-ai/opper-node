...
| `spanCount`                                                                                   | *number*                                                                                      | :heavy_minus_sign:                                                                            | Total number of spans in the trace                                                            |
| `generationCount`                                                                             | *number*                                                                                      | :heavy_minus_sign:                                                                            | Number of LLM generation spans in the trace                                                   |
| `toolCount`                                                                                   | *number*                                                                                      | :heavy_minus_sign:                                                                            | Number of tool/function call spans in the trace                                               |
| `hasError`                                                                                    | *boolean*                                                                                     | :heavy_minus_sign:                                                                            | Whether any span in the trace has an error                                                    |
