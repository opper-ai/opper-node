...
```typescript
import { ChatCompletionMessageOutput } from "opperai/models";

let value: ChatCompletionMessageOutput = {};
```
...
| `toolCalls`                                                    | *models.ChatCompletionMessageOutputToolCall*[]                 | :heavy_minus_sign:                                             | N/A                                                            |
